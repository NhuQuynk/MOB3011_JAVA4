...
<body>
	...
	<form action="/ASM_JAVA4/video/update?id=${video.id}" method="post">
...
<div class="col-sm-9 mb-3">
	...
	<div class="col-md-8">
		<input type="file" name="poster" value="${video.poster }">
	</div>
</div>
...
<div class="col-sm-9 mb-3">
	...
	<div class="col-md-8">
		<input class="form-control" type="text" name="category.id" value="${video.category.id }">
	</div>
</div>
			...
			<c:forEach items="${dsV}" var="obj">
				<tr>
					...
					<td><img
						...
						class="card-img-top" alt="Card image card" height="70px">
					</td>
